...
export function AppShell({ step, children }: Props) {
  return (
    <div className="flex min-h-screen flex-col bg-[var(--bg)] text-foreground">
      ...
      <footer className="border-t border-[color-mix(in_oklab,var(--rim)_8%,transparent)] py-6 text-center font-[family-name:var(--font-space-mono)] text-[10px] uppercase tracking-widest text-fg-ghost">
